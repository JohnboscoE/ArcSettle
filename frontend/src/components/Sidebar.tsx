  ...
  <aside className="hidden md:flex fixed top-0 left-0 bottom-0 w-56 bg-card border-r border-border flex-col z-50">
    ...
    <div className="px-5 py-6 border-b border-border">
      <div className="flex items-center gap-2.5">
        <div className="w-8 h-8 bg-accent rounded-lg flex items-center justify-center text-sm font-bold text-[#003830]">
          A
        </div>
        <div>
          <div className="text-sm font-semibold text-t1">ArcSettle</div>
          <div className="text-[9px] text-t3 tracking-wider">
            ARC · CIRCLE · USDC
          </div>
        </div>
      </div>
